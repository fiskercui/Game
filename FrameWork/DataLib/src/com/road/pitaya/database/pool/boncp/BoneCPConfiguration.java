...
public class BoneCPConfiguration
{
    ...
    private int minConnectionsPerPartition = DEFAULT_MIN_CONNECTIONS_PER_PARTITION;
    ...
    public BoneCPConfiguration(String jdbcUrl, String name, String password)
    {
        setJdbcUrl(jdbcUrl);
        setName(name);
    ...
    {
        this.setJdbcUrl(element.elementText("Url"));
        this.setName(element.elementText("Name"));
        this.setPassword(element.elementText("Password"));
    ...
    public BoneCPConfiguration setName(String name)
    {
        this.name = name;
        return this;
    }
    ...
    public BoneCPConfiguration setPassword(String password)
    {
